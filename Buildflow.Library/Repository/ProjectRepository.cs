...
public async Task<BoqDetailsFullDto?> GetBoqDetailsAsync(string code)
        ...
        public async Task<BaseResponse> UpsertProjectAsync(ProjectInput dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.Success = false;
                response.Message = "An error occurred while saving the project: " + ex.Message;
                response.Data = 0;
            }
     ...
     CALL project.upsert_boq(
         ...
         @out_boq_id
            ...
            catch (Exception ex)
            {
                ...
                response.Success = false;
                response.Message = "An error occurred while saving BOQ data: " + ex.Message;
                response.Data = false;
            }
        ...
        public async Task<BaseResponse> UpsertProjectBudgetDetails(ProjectBudgetInputDto dto)
        {
            ...
            try
            {
                ...
                await con.ExecuteAsync("CALL project.upsert_project_budget(@iproject_id, @budget_data, @message, @status);", parameters);
            ...
            catch (Exception ex)
            {
                _logger.LogError("Error inserting project budget details: " + ex.Message);
                response.Success = false;
                response.Message = "An error occurred while inserting budget details: " + ex.Message;
                response.Data = false;
            }
        ...
        public async Task<BaseResponse> UpsertProjectMilestoneDetails(ProjectMilestoneInputDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.Success = false;
                response.Message = "An error occurred while inserting milestone details: " + ex.Message;
                response.Data = false;
            }
        ...
        public async Task<BaseResponse> UpsertProjectTeam(ProjectTeamInputDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.Success = false;
                response.Message = "An error occurred while inserting team members: " + ex.Message;
                response.Data = false;
            }
        ...
        public async Task<(bool Success, string Message, object Data)> UpsertProjectTeamAsync(ProjectTeamUpsertDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                string errorDetails = $"Exception in UpsertProjectTeamAsync: {ex.Message}";
        ...
        public async Task<BaseResponse> UpsertProjectPermissionFinanceApproval(ProjectPermissionFinanceApprovalInputDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.Success = false;
                response.Message = "An error occurred while inserting project permission finance approval: " + ex.Message;
                response.Data = false;
            }
            return response;
        }
        ...
        public async Task UpsertProjectApprovalAsync(int approvedBy, int ticketId, string approvalType)
        {
            ...
            {
                throw new Exception("An unexpected error occurred while inserting project approval.", ex);
            }
        }
