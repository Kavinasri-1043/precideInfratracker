...
namespace Buildflow.Library.Repository
{
    public class VendorRepository : IVendorRepository
    {
        ...
        private ILogger<VendorRepository> vendorLogger;
       ...
       // public VendorRepository(IConfiguration configuration, BuildflowAppContext context, ILogger<VendorRepository> vendorLogger)
      //  {
       //     _configuration = configuration;
          //  _context = context;
                    ...
                    try
                    {
                        ...
                        if (!ordersDict.TryGetValue(purchaseOrderId, out var order))
                        {
                            order = new PurchaseOrderWithItemsDto
                            {
                                ...
                                VendorMobile = reader.GetString(8),
                                PurchaseManagerMobile = reader.GetString(9),
                        ...
                        if (!reader.IsDBNull(9))
                        {
                            ...
                            {
                                PurchaseOrderItemsId = reader.GetInt32(9),
                                ...
                                Quantity = reader.IsDBNull(13) ? null : reader.GetInt32(13),
                                Total = reader.IsDBNull(14) ? null : reader.GetDouble(14)
                            });
                        }
                    }
                    catch (Exception ex)
