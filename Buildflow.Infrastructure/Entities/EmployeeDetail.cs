...
public partial class EmployeeDetail
{
    ...
    public virtual ICollection<TicketAssignee> TicketAssigneeAssignByNavigations { get; set; } = new List<TicketAssignee>();

    public virtual ICollection<TicketAssignee> TicketAssigneeAssignees { get; set; } = new List<TicketAssignee>();
    ...
    public virtual ICollection<TicketMovement> TicketMovementMoveByNavigations { get; set; } = new List<TicketMovement>();

    public virtual ICollection<TicketMovement> TicketMovementMoveToNavigations { get; set; } = new List<TicketMovement>();
