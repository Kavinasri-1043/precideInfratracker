        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by = table.Column<int>(type: "integer", nullable: true),
                    updated_by = table.Column<int>(type: "integer", nullable: true),
                    is_allocated = table.Column<bool>(type: "boolean", nullable: true, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("materialcategory_pkey", x => x.materialcategoryid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    report_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    report_code = table.Column<string>(type: "character varying", nullable: true),
                    report_type = table.Column<string>(type: "character varying", nullable: false),
                    project_id = table.Column<string>(type: "character varying", nullable: false),
                    report_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    reported_by = table.Column<string>(type: "character varying", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    notification_type = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "notifications_emp_id_fkey",
                        column: x => x.emp_id,
                        principalSchema: "employee",
                        principalTable: "employee_details",
                        principalColumn: "emp_id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("attachment_pkey", x => x.attachment_id);
                    table.ForeignKey(
                        name: "attachment_report_id_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("department_role_mapping_pkey", x => x.id);
                    table.ForeignKey(
                        name: "department_role_mapping_dept_id_fkey",
                        column: x => x.dept_id,
                        principalSchema: "master",
                        principalTable: "department",
                        principalColumn: "dept_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "department_role_mapping_role_id_fkey",
                        column: x => x.role_id,
                        principalSchema: "master",
                        principalTable: "role",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    vendor_dept_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("department_pkey", x => x.vendor_dept_id);
                    table.ForeignKey(
                        name: "fk_vendor",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    vendor_role_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    vendor_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("vendorrole_pkey", x => x.vendor_role_id);
                    table.ForeignKey(
                        name: "vendorrole_role_id_fkey",
                        column: x => x.role_id,
                        principalSchema: "master",
                        principalTable: "role",
                        principalColumn: "role_id");
                    table.ForeignKey(
                        name: "vendorrole_vendor_id_fkey",
                        column: x => x.vendor_id,
                        principalSchema: "vendor",
                        principalTable: "vendor",
                        principalColumn: "vendor_id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    boq_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    boq_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    boq_code = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("boq_pkey", x => x.boq_id);
                    table.ForeignKey(
                        name: "fk_boq_emp",
                        column: x => x.created_by,
                        principalSchema: "employee",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GRN = table.Column<string>(type: "text", nullable: true),
                    ItemName = table.Column<string>(type: "text", nullable: true),
                    VendorId = table.Column<int>(type: "integer", nullable: true),
                    QuantityReceived = table.Column<decimal>(type: "numeric", nullable: true),
                    Unit = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockInwards", x => x.StockInwardId);
                    table.ForeignKey(
                        name: "FK_StockInwards_employee_details_ReceivedById",
                    ...
                    table.ForeignKey(
                        name: "FK_StockInwards_project_ProjectId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockInwards_vendor_VendorId",
                        column: x => x.VendorId,
                        principalSchema: "vendor",
                        principalTable: "vendor",
                        principalColumn: "vendor_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockOutwardId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    IssueNo = table.Column<string>(type: "text", nullable: true),
                    ItemName = table.Column<string>(type: "text", nullable: true),
                    RequestedById = table.Column<int>(type: "integer", nullable: true),
                    IssuedToId = table.Column<int>(type: "integer", nullable: true),
                    Unit = table.Column<string>(type: "text", nullable: true),
                    IssuedQuantity = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockOutwards", x => x.StockOutwardId);
                    table.ForeignKey(
                        name: "FK_StockOutwards_employee_details_IssuedToId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockOutwards_employee_details_RequestedById",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockOutwards_project_ProjectId",
                        column: x => x.ProjectId,
                        principalSchema: "project",
                        principalTable: "project",
                        principalColumn: "project_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    boq_items_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    boq_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("boq_items_pkey", x => x.boq_items_id);
                    table.ForeignKey(
                        name: "fk_boq_items_boq",
                        column: x => x.boq_id,
                        principalSchema: "project",
                        principalTable: "boq",
                        principalColumn: "boq_id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    purchase_order_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    po_id = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    boq_id = table.Column<int>(type: "integer", nullable: true),
                    created_by = table.Column<int>(type: "integer", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    ...
                    delivery_status_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    move_by = table.Column<int>(type: "integer", nullable: true),
                    move_to = table.Column<int>(type: "integer", nullable: true),
                    boq_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "emp_id");
                    table.ForeignKey(
                        name: "fk_ticket_move_by",
                        column: x => x.move_by,
                        principalSchema: "employee",
                        principalTable: "employee_details",
                        principalColumn: "emp_id");
                    table.ForeignKey(
                        name: "fk_ticket_move_to",
                        column: x => x.move_to,
                        principalSchema: "employee",
                        principalTable: "employee_details",
                        principalColumn: "emp_id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    purchase_order_items_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("purchase_order_items_pkey", x => x.purchase_order_items_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    boq_approval_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    boq_id = table.Column<int>(type: "integer", nullable: true),
                    ticket_id = table.Column<int>(type: "integer", nullable: true),
                    approval_status = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    updated_by = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("boq_approval_pkey", x => x.boq_approval_id);
                    table.ForeignKey(
                        name: "fk_boq_approval_boq",
                        column: x => x.boq_id,
                        principalSchema: "project",
                        principalTable: "boq",
                        principalColumn: "boq_id");
                    table.ForeignKey(
                        name: "fk_boq_ticket_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "project_approval_ticket_id_fkey",
                        column: x => x.ticket_id,
                        principalSchema: "ticket",
                        principalTable: "tickets",
                        principalColumn: "ticket_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    purchase_order_approval_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    purchase_order_id = table.Column<int>(type: "integer", nullable: true),
                    ticket_id = table.Column<int>(type: "integer", nullable: true),
                    approval_status = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("purchase_order_approval_pkey", x => x.purchase_order_approval_id);
                    table.ForeignKey(
                        name: "fk_po_approval_order",
                        column: x => x.purchase_order_id,
                        principalSchema: "vendor",
                        principalTable: "purchase_order",
                        principalColumn: "purchase_order_id");
                    table.ForeignKey(
                        name: "fk_po_approval_ticket",
                        column: x => x.ticket_id,
                        principalSchema: "ticket",
                        principalTable: "tickets",
                        principalColumn: "ticket_id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ticket_assignee_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ticket_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ticket_assignee_pkey", x => x.ticket_assignee_id);
                    table.ForeignKey(
                        name: "fk_assign_by",
                        column: x => x.assign_by,
                        principalSchema: "employee",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ticket_comments_pkey", x => x.comment_id);
                    table.ForeignKey(
                        name: "fk_created_by",
                        column: x => x.created_by,
                        principalSchema: "employee",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    move_by = table.Column<int>(type: "integer", nullable: true),
                    move_to = table.Column<int>(type: "integer", nullable: true),
                    moved_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("ticket_movements_pkey", x => x.movement_id);
                    table.ForeignKey(
                        name: "fk_move_by",
                        column: x => x.move_by,
                        principalSchema: "employee",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ticket_participants_pkey", x => x.id);
                    table.ForeignKey(
                        name: "fk_ticket_participant_added_by",
                        column: x => x.added_by,
                        principalSchema: "employee",
                        principalTable: "employee_details",
                        principalColumn: "emp_id");
                    table.ForeignKey(
                        name: "fk_ticket_participant_employee",
                        column: x => x.participant_id,
                        principalSchema: "employee",
                        principalTable: "employee_details",
                        principalColumn: "emp_id");
                    table.ForeignKey(
                        name: "fk_ticket_participant_ticket",
                        column: x => x.ticket_id,
                        principalSchema: "ticket",
                        principalTable: "tickets",
                        principalColumn: "ticket_id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by = table.Column<int>(type: "integer", nullable: false),
                    created_date = table.Column<DateOnly>(type: "date", nullable: true),
                    ticket_comment_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("attachment_pkey", x => x.attachment_id);
            ...
            migrationBuilder.CreateIndex(
                name: "uq_report_attachment_report_file",
                schema: "report",
                table: "attachment",
                columns: new[] { "report_id", "file_name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_attachment_created_by",
                schema: "ticket",
                table: "attachment",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "IX_attachment_ticket_comment_id",
                schema: "ticket",
                table: "attachment",
                column: "ticket_comment_id");

            migrationBuilder.CreateIndex(
                name: "IX_attachment_ticket_id",
                schema: "ticket",
                table: "attachment",
                column: "ticket_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_boq_created_by",
                schema: "project",
                table: "boq",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "IX_boq_project_id",
                schema: "project",
                table: "boq",
                column: "project_id");

            migrationBuilder.CreateIndex(
                name: "IX_boq_vendor_id",
                schema: "project",
                table: "boq",
                column: "vendor_id");

            migrationBuilder.CreateIndex(
                name: "IX_boq_approval_boq_id",
                schema: "project",
                table: "boq_approval",
                column: "boq_id");

            migrationBuilder.CreateIndex(
                name: "IX_boq_approval_ticket_id",
                schema: "project",
                table: "boq_approval",
                column: "ticket_id");

            migrationBuilder.CreateIndex(
                name: "IX_boq_items_boq_id",
                schema: "project",
                table: "boq_items",
                column: "boq_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_department_dept_id",
                schema: "vendor",
                table: "department",
                column: "dept_id");

            migrationBuilder.CreateIndex(
                name: "IX_department_vendor_id",
                schema: "vendor",
                table: "department",
                column: "vendor_id");

            migrationBuilder.CreateIndex(
                name: "department_role_mapping_dept_id_role_id_key",
                schema: "master",
                table: "department_role_mapping",
                columns: new[] { "dept_id", "role_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_department_role_mapping_role_id",
                schema: "master",
                table: "department_role_mapping",
                column: "role_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_material_vendor_id",
                schema: "vendor",
                table: "material",
                column: "vendor_id");

            migrationBuilder.CreateIndex(
                name: "idx_notifications_emp_id",
                schema: "notification",
                table: "notifications",
                column: "emp_id");

            migrationBuilder.CreateIndex(
                name: "idx_notifications_emp_id_is_read",
                schema: "notification",
                table: "notifications",
                columns: new[] { "emp_id", "is_read" });

            migrationBuilder.CreateIndex(
                name: "idx_notifications_timestamp_desc",
                schema: "notification",
                table: "notifications",
                column: "timestamp",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_project_approval_ticket_id",
                schema: "project",
                table: "project_approval",
                column: "ticket_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_purchase_order_approval_purchase_order_id",
                schema: "vendor",
                table: "purchase_order_approval",
                column: "purchase_order_id");

            migrationBuilder.CreateIndex(
                name: "IX_purchase_order_approval_ticket_id",
                schema: "vendor",
                table: "purchase_order_approval",
                column: "ticket_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockInwards_ProjectId",
                table: "StockInwards",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_StockInwards_ReceivedById",
                table: "StockInwards",
                column: "ReceivedById");

            migrationBuilder.CreateIndex(
                name: "IX_StockInwards_VendorId",
                table: "StockInwards",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOutwards_IssuedToId",
                table: "StockOutwards",
                column: "IssuedToId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOutwards_ProjectId",
                table: "StockOutwards",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOutwards_RequestedById",
                table: "StockOutwards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_assignee_assign_by",
                schema: "ticket",
                table: "ticket_assignee",
                column: "assign_by");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_assignee_assignee_id",
                schema: "ticket",
                table: "ticket_assignee",
                column: "assignee_id");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_assignee_ticket_id",
                schema: "ticket",
                table: "ticket_assignee",
                column: "ticket_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_movements_move_by",
                schema: "ticket",
                table: "ticket_movements",
                column: "move_by");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_movements_move_to",
                schema: "ticket",
                table: "ticket_movements",
                column: "move_to");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_movements_ticket_id",
                schema: "ticket",
                table: "ticket_movements",
                column: "ticket_id");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_participants_added_by",
                schema: "ticket",
                table: "ticket_participants",
                column: "added_by");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_participants_participant_id",
                schema: "ticket",
                table: "ticket_participants",
                column: "participant_id");

            migrationBuilder.CreateIndex(
                name: "IX_ticket_participants_ticket_id",
                schema: "ticket",
                table: "ticket_participants",
                column: "ticket_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tickets_move_by",
                schema: "ticket",
                table: "tickets",
                column: "move_by");

            migrationBuilder.CreateIndex(
                name: "IX_tickets_move_to",
                schema: "ticket",
                table: "tickets",
                column: "move_to");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vendorrole_role_id",
                schema: "vendor",
                table: "vendorrole",
                column: "role_id");

            migrationBuilder.CreateIndex(
                name: "IX_vendorrole_vendor_id",
                schema: "vendor",
                table: "vendorrole",
                column: "vendor_id");
        }
