...
public partial class BuildflowAppContext : DbContext
{
    ...
    public virtual DbSet<Attachment1> Attachments1 { get; set; }
    ...
    public DbSet<StockInward> StockInwards { get; set; }   // ✅ Fixes your error
    public DbSet<StockOutward> StockOutwards { get; set; } // ✅ For outward items

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=103.91.186.169;Port=5432;Database=buildflow_live_db;Username=postgres;Password=Admin@123");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Attachment>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.Attachments)
                ...
                .HasConstraintName("fk_attachment_created_by");
        ...
        modelBuilder.Entity<Attachment1>(entity =>
        {
            entity.HasKey(e => e.AttachmentId).HasName("attachment_pkey");

            entity.ToTable("attachment", "report");

            entity.HasIndex(e => new { e.ReportId, e.FileName }, "uq_report_attachment_report_file").IsUnique();
            ...
            entity.HasOne(d => d.Report).WithMany(p => p.Attachment1s)
                .HasForeignKey(d => d.ReportId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("attachment_report_id_fkey");
        });
        ...
        modelBuilder.Entity<TicketAssignee>(entity =>
        {
            ...
            entity.HasOne(d => d.AssignByNavigation).WithMany(p => p.TicketAssigneeAssignByNavigations)
                .HasForeignKey(d => d.AssignBy)
                .HasConstraintName("fk_assign_by");

            entity.HasOne(d => d.Assignee).WithMany(p => p.TicketAssigneeAssignees)
                .HasForeignKey(d => d.AssigneeId)
                .HasConstraintName("fk_assign_to");
        ...
        modelBuilder.Entity<TicketMovement>(entity =>
        {
            ...
            entity.HasOne(d => d.MoveByNavigation).WithMany(p => p.TicketMovementMoveByNavigations)
                .HasForeignKey(d => d.MoveBy)
                .HasConstraintName("fk_move_by");

            entity.HasOne(d => d.MoveToNavigation).WithMany(p => p.TicketMovementMoveToNavigations)
                .HasForeignKey(d => d.MoveTo)
                .HasConstraintName("fk_move_to");
